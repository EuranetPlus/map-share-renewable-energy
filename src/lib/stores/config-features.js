export const config = {
	mapTitle: 'share-of-renewables', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-share-renewable-energy.vercel.app/', // The url provided when deploying the map on Vercel
